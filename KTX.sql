...
USE QL_KyTucXa; -- Thay thế QL_KyTucXa bằng tên Database của bạn nếu cần thiết 
GO
...
INSERT INTO QuanLy (MaQuanLy, HoTenQuanLy, MaToaQuanLy) VALUES
    ('QL001', N'Đinh Thanh Danh', 'A'),
    ('QL002', N'Phạm Cẩm Đào', 'B'),
...
-- NAM - TÒA A
-- A101 (4 SV)
('SV001', N'Phan Văn Khải', N'Marketing', '0901234567', 'A101', N'Nam', '2005-12-02', '2025-09-01', N'Hà Nội'),
('SV003', N'Nguyễn Trung Hiếu', N'Marketing', '0913174143', 'A101', N'Nam', '2006-10-15', '2025-03-08', N'An Giang'),
('SV005', N'Dương Thành Đạt', N'CNTT', '0949055708', 'A101', N'Nam', '2003-02-02', '2023-10-09', N'Bến Tre'),
('SV006', N'Lê Minh Đức', N'CNTT', '0375616199', 'A101', N'Nam', '2007-04-02', '2025-11-01', N'Đồng Tháp'),
-- A102 (4 SV)
('SV007', N'Nguyễn Nhất Anh', N'CNTT', '0912345678', 'A102', N'Nam', '2005-07-12', '2025-09-15', N'Hải Phòng'),
('SV009', N'Lê Tuấn Anh', N'Trí tuệ nhân tạo', '0976543210', 'A102', N'Nam', '2006-05-18', '2025-03-30', N'Quảng Ninh'),
('SV011', N'Trần Vũ Duy', N'Luật', '0911222333', 'A102', N'Nam', '2005-01-25', '2025-10-12', N'Nam Định'),
('SV013', N'Phan Khánh Duy', N'Y khoa', '0988776655', 'A102', N'Nam', '2006-12-01', '2025-12-01', N'Thừa Thiên Huế'),
-- A103 (4 SV)
('SV015', N'Huỳnh Nguyễn Phương Đông', N'CNTT', '0912345001', 'A103', N'Nam', '2005-01-12', '2025-09-10', N'Hà Nội'),
('SV017', N'Lê Văn Định', N'Kỹ thuật phần mềm', '0912345003', 'A103', N'Nam', '2006-07-18', '2025-03-20', N'Đà Nẵng'),
('SV019', N'Nguyễn Tuấn Hải', N'Trí tuệ nhân tạo', '0912345005', 'A103', N'Nam', '2005-05-25', '2025-11-01', N'Nam Định'),
('SV021', N'Nguyễn Phi Hùng', N'Luật', '0912345007', 'A103', N'Nam', '2006-02-01', '2025-12-01', N'Thừa Thiên Huế'),
-- A104 (4 SV)
('SV023', N'Bùi Phước Hậu', N'Logistics', '0912345009', 'A104', N'Nam', '2005-08-30', '2025-09-15', N'Quảng Ninh'),
('SV025', N'Trương Quốc Khải', N'Y khoa', '0912345011', 'A104', N'Nam', '2006-04-05', '2025-03-30', N'Bình Định'),
('SV027', N'Trương Quốc Bảo', N'Quản trị kinh doanh', '0912345013', 'A104', N'Nam', '2005-02-14', '2025-10-12', N'Cần Thơ'),
('SV029', N'Trịnh Minh Phương Hào', N'CNTT', '0912345015', 'A104', N'Nam', '2006-01-25', '2025-12-01', N'An Giang'),
-- A105 (4 SV)
('SV031', N'Nguyễn Phước Hào', N'Kỹ thuật phần mềm', '0912345017', 'A105', N'Nam', '2005-09-09', '2025-09-20', N'Long An'),
('SV033', N'Phạm Ngoc Hiển', N'Trí tuệ nhân tạo', '0912345019', 'A105', N'Nam', '2006-06-18', '2025-03-30', N'Quảng Bình'),
('SV035', N'Huỳnh Công Huy', N'CNTT', '0912345021', 'A105', N'Nam', '2005-04-12', '2025-09-10', N'Hà Giang'),
('SV037', N'Lâm Ngọc Hùng Cường', N'Kỹ thuật phần mềm', '0912345023', 'A105', N'Nam', '2006-07-18', '2025-03-20', N'Quảng Nam'),
-- A206 (6 SV)
('SV071', N'Hàng Thái Anh', N'Y khoa', '0912345057', 'A206', N'Nam', '2005-04-05', '2025-03-30', N'Đắk Nông'),
('SV073', N'Lê Phúc Đức Hiền', N'Khoa học dữ liệu', '0912345059', 'A206', N'Nam', '2006-02-14', '2025-10-12', N'Tây Ninh'),
('SV075', N'Nguyễn Hoàng Giang', N'Quản trị kinh doanh', '0912345061', 'A206', N'Nam', '2005-01-25', '2025-12-01', N'Vĩnh Long'),
('SV077', N'Nguyễn Bùi Hữu Duy', N'CNTT', '0912345063', 'A206', N'Nam', '2006-09-09', '2025-09-20', N'An Giang'),
('SV079', N'Nguyễn Văn Chiến', N'Trí tuệ nhân tạo', '0912345065', 'A206', N'Nam', '2005-06-18', '2025-03-30', N'Quảng Trị'),
('SV081', N'Ngô Văn Hưng', N'Kỹ thuật phần mềm', '0912345067', 'A206', N'Nam', '2006-04-12', '2025-09-10', N'Lạng Sơn'),
-- NAM - TÒA C
-- C101 (4 SV)
...
-- NỮ - TÒA B 
-- B101 (4 SV)
('SV002', N'Hoàng Thị Mỹ Anh', N'Marketing', '0919876543', 'B101', N'Nữ', '2004-03-02', '2024-12-09', N'TP. Hồ Chí Minh'),
('SV004', N'Châu Ngọc Bích', N'CNTT', '0947060710', 'B101', N'Nữ', '2005-11-07', '2023-10-01', N'Cần Thơ'),
('SV008', N'Bùi Nguyễn Chiêu Anh', N'Marketing', '0938765432', 'B101', N'Nữ', '2004-11-23', '2024-12-20', N'Đà Nẵng'),
('SV010', N'Đổng Ngọc Phương Dung', N'Ngôn ngữ Anh', '0909988776', 'B101', N'Nữ', '2003-09-09', '2023-11-05', N'Khánh Hòa'),
-- B102 (4 SV)
